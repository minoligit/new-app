...
function Employees(){
    ...
    return(
        <div className="Content">
            ...
            <div id="searchBar">
                ...
                <div style={{fontSize:"120%",textAlign:"center"}}>
                    <button type="submit" value="submitAND" onClick={(e)=>{searchAND()}}
                        style={{width:"20%",backgroundColor:"#9690eb",borderRadius:"15px",margin:"2%"}}>
                        AND</button>
                ...
                <div style={{fontSize:"120%",textAlign:"center"}}>   
                    <button type="submit" value="submit" onClick={searchEmployee}
                        style={{width:"10%",color:"white",backgroundColor:"blue",borderRadius:"15px",margin:"2%"}}>
                        Enter</button>
                    <button type="submit" onClick={resetTable}
                        style={{width:"10%",color:"white",backgroundColor:"#F08080",borderRadius:"15px",margin:"2%"}}>
                        Reset</button>
                </div>
            </div>           
            <br/><br/>
            <div>
                Rows per page
                <select onChange={(e)=>{setPagination(e)}}>
